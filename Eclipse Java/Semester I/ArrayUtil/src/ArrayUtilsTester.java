...
public class ArrayUtilsTester {
    ...
    public static void main(String [] args) {
        ...
        System.out.println("Diag: " + ArrayUtils.onDiagonal(m4, 1)); //prints false, should be true
        
        int[] l1 = { 0, 0, 0, 0 };
        int[] i1 = { 1, 2, 3, 4 }; //3rd index prints 0, should be 4
        ...
        int[] l3 = { 3, 4 };
        int[] i3 = { 5, 6, 7, 8 }; //1st index prints 4, should be 10
